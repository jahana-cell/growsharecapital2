...
export default function Header() {
  ...
  return (
    <header className={
"sticky top-0 z-50 w-full transition-all duration-500 border-b border-neutral-100 " +
        ...
        <NavigationMenu>
            <NavigationMenuList>
                {mainCategories.map((category) => (
                 ...
                 <NavigationMenuItem>
                    <NavigationMenuLink asChild>
                        <Link href="/news" className={cn(navigationMenuTriggerStyle(), "bg-transparent text-[10px] tracking-[0.25em] font-bold uppercase text-neutral-500 h-auto py-4")}>
                            News
                        </Link>
                    </NavigationMenuLink>
                </NavigationMenuItem>
                 <NavigationMenuItem>
                    <NavigationMenuLink asChild>
                        <Link href="/contact" className={cn(navigationMenuTriggerStyle(), "bg-transparent text-[10px] tracking-[0.25em] font-bold uppercase text-neutral-500 h-auto py-4")}>
                            Contact
                        </Link>
                    </NavigationMenuLink>
                </NavigationMenuItem>
...
const SiteMenu = ({ isMenuOpen, setMenuOpen }: { isMenuOpen: boolean, setMenuOpen: (open: boolean) => void }) => {
  ...
  return (
    <Sheet open={isMenuOpen} onOpenChange={setMenuOpen}>
      ...
      <SheetContent side="left" className="w-[85vw] sm:w-[400px] p-0 flex flex-col bg-[#FAFAF9] h-full border-r border-neutral-200 z-[100]">
