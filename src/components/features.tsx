...
const FeatureCard = ({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) => (
  <div className="bg-white p-8 rounded-lg shadow-lg text-center">
    ...
    <h3 className="text-2xl font-bold text-deep-blue mb-4 font-serif">{title}</h3>
  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center text-deep-blue mb-12 font-serif">Our Focus Areas</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <FeatureCard
            icon={<Leaf size={48} className="text-forest-green" />}
            title="Livestock"
          ...
          />
          <FeatureCard
            icon={<Heart size={48} className="text-forest-green" />}
            title="Healthcare"
          ...
          />
          <FeatureCard
            icon={<Building size={48} className="text-forest-green" />}
