    ...
    <div className="bg-cream-base min-h-screen text-truffle-dark selection:bg-gold-accent selection:text-white">
        ...
        <div className="container mx-auto max-w-[1800px]">
          ...
          >
            <div className="flex items-center gap-4 mb-6 md:mb-8">
              <span className="h-[1px] w-8 md:w-12 bg-gold-accent"></span>
              <p className="text-[10px] md:text-xs tracking-[0.4em] uppercase font-bold text-stone-400">
                Contact
              </p>
            </div>
            
            <h1 className="text-5xl md:text-8xl font-serif leading-[0.95] md:leading-[0.9] text-truffle-dark mb-6 md:mb-8">
      ...
      <main className="w-full">
        <div className="grid lg:grid-cols-12 min-h-[80vh]">
          ...
          <div className="lg:col-span-4 bg-[#FDFCFB] px-6 py-12 md:p-16 lg:border-r border-stone-200/60 order-2 lg:order-1">
             <div className="lg:sticky lg:top-12 space-y-12 md:space-y-16">
                ...
                <div className="space-y-10 md:space-y-12">
                  {/* Headquarters */}
                  <div className="group">
                    <h3 className="font-serif text-2xl mb-4 group-hover:text-gold-accent transition-colors duration-500 text-truffle-dark">Headquarters</h3>
                    <address className="not-italic text-stone-500 font-light leading-loose text-sm">
                      3622 Central Ave<br />
                      Memphis, TN 38111<br />
                      United States
                    </address>
                    <a href="https://maps.google.com/?q=3622+Central+Ave,Memphis,TN+38111" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 mt-4 text-[10px] uppercase tracking-widest font-bold border-b border-transparent hover:border-gold-accent transition-all pb-0.5 text-truffle-dark">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <a href="tel:+12144736888" className="font-serif text-xl hover:text-gold-accent transition-colors text-truffle-dark">
                        +1 (214) 473-6888
                      </a>
                      <div className="mt-1">
                         <a href="https://wa.me/12144736888" target="_blank" rel="noopener noreferrer" className="text-xs text-stone-400 hover:text-gold-accent transition-colors">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@growsharecapital.com" className="font-serif text-xl hover:text-gold-accent transition-colors break-all text-truffle-dark">
          ...
          {/* RIGHT: Inquiry Form */}
          <div className="lg:col-span-8 bg-cream-base relative order-1 lg:order-2">
             <div className="w-full h-full px-6 py-16 md:p-24 lg:p-32">
                <div className="max-w-2xl mx-auto">
                   <h3 className="text-3xl font-serif mb-2 text-truffle-dark">Send a Message</h3>
      ...
      <section className="h-64 md:h-[50vh] w-full relative grayscale hover:grayscale-0 transition-all duration-[1.5s] ease-in-out">
         ...
         />
         <div className="absolute inset-0 bg-cream-base/10 pointer-events-none" />
         
         <div className="absolute bottom-6 left-6 md:bottom-12 md:left-12 bg-white/95 backdrop-blur-sm p-6 md:p-8 max-w-[calc(100%-3rem)] md:max-w-sm border border-stone-200 shadow-2xl rounded-sm">
            <MapPin className="h-5 w-5 md:h-6 md:w-6 text-gold-accent mb-3 md:mb-4" />
            <p className="font-serif text-base md:text-lg text-truffle-dark">GrowShare Capital HQ</p>
...
export default function ContactPage() {
  return (
    <Suspense fallback={
        <div className="h-screen w-full flex items-center justify-center bg-cream-base">
            <div className="w-px h-24 bg-stone-200 overflow-hidden relative">
                <div className="absolute top-0 left-0 w-full h-full bg-gold-accent animate-slideDown" />
            </div>
        </div>
    }>
      <ContactContent />
